...
@Component({
 ...
 <div [ngClass]="aplicaCssErro('nome')">
  ...
  <app-campo-control-erro [show]="hasError('nome', 'required')" msgErro="Nome é obrigatório" ></app-campo-control-erro>
  <app-campo-control-erro [show]="hasError('nome', 'minlength')" msgErro="Ao menos 3 caracteres" ></app-campo-control-erro>
</div>
<div [ngClass]="aplicaCssErro('email')">
  <label>Email: <input type="email" formControlName="email" placeholder="nome@email.com" ></label><br/>
  <app-campo-control-erro [show]="hasError('email', 'required')" msgErro="Email é obrigatório" ></app-campo-control-erro>
  <app-campo-control-erro [show]="hasError('email', 'email')" msgErro="Email inválido" ></app-campo-control-erro>
  </div>
